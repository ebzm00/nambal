...
public class OutAdapter extends RecyclerView.Adapter<OutAdapter.OutViewHolder> {
    ...
    public class OutViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
        ...
        public OutViewHolder(@NonNull View view) {
            super(view);
            this.name = (TextView) view.findViewById(R.id.name_listitem_out);
            this.nowDate = (TextView) view.findViewById(R.id.nowDate_listitem_out);
            this.date = (TextView) view.findViewById(R.id.date_listitem_out);
            this.count = (TextView) view.findViewById(R.id.count_listitem_out);
...
//    public OutAdapter(ArrayList<Food> list) {
//        this.mList = list;
//    }

    public OutAdapter(Context context, ArrayList<Food> list) {
    ...
    @NonNull
    @Override
    public OutViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_out_item, viewGroup, false);
        OutViewHolder viewHolder = new OutViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull OutViewHolder viewHolder, int position) {
