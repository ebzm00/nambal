...
public class FreezeAdapter extends RecyclerView.Adapter<FreezeAdapter.FreezeViewHolder> {

    private ArrayList<Food> mList;
    private Context mContext;

    public class FreezeViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
        ...
        public FreezeViewHolder(@NonNull View view) {
            super(view);
            this.name = (TextView) view.findViewById(R.id.name_listitem_freeze);
            this.nowDate = (TextView) view.findViewById(R.id.nowDate_listitem_freeze);
            this.date = (TextView) view.findViewById(R.id.date_listitem_freeze);
            this.count = (TextView) view.findViewById(R.id.count_listitem_freeze);
...
//    public FreezeAdapter(ArrayList<Food> list) {
//        this.mList = list;
//    }

    public FreezeAdapter(Context context, ArrayList<Food> list) {
    ...
    @NonNull
    @Override
    public FreezeViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_freeze_item, viewGroup, false);
        FreezeViewHolder viewHolder = new FreezeViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull FreezeViewHolder viewHolder, int position) {
